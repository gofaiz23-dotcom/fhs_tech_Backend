...
import { uploadSingle, uploadSingleHybrid, uploadImages, conditionalImageUpload, uploadFileAndImages, handleUploadError } from '../middlewares/upload.js';
...
router.post('/', uploadFileAndImages, handleUploadError, ProductController.bulkCreateProducts); // 4. Add products (single/multiple/CSV/Excel) + image files support
